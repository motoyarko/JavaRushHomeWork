...
public class Solution {
    ...
    public static void reset() throws IOException
    {
        ...
        String selectMachine = bufferedReader.readLine();
        if (selectMachine.equals("helicopter")) {
            result = new Helicopter();
        }
        if (selectMachine.equals("plane")) {
            int secondParametr = Integer.parseInt(bufferedReader.readLine());
            result = new Plane(secondParametr);
        }
